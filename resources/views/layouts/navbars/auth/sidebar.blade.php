    ...
    <ul class="navbar-nav">
      ...
      {{-- <li class="nav-item">
        ...
        <li class="nav-item pb-2">
          <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ route('user-management.index')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      @endif
      @if (auth()->user()->role->role_name === 'Finance' || auth()->user()->role->role_name === 'Manager Business Development')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('finance') ? 'active' : '') }}" href="{{ route('finance.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-money-bill-wave text-dark"></i>
          </div>
          <span class="nav-link-text ms-1">Input Finance</span>
        </a>
      </li>
      @endif
      @if (auth()->user()->role->role_name === 'Operational' || auth()->user()->role->role_name === 'Manager Business Development')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('operational') ? 'active' : '') }}" href="{{ route('operational.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa-solid fa-gears text-dark"></i>
          </div>
          <span class="nav-link-text ms-1">Input Operational</span>
        </a>
      </li>
      @endif
      @if (auth()->user()->role->role_name === 'Area Manager' || auth()->user()->role->role_name === 'Store Manager' || auth()->user()->role->role_name === 'Manager Business Development') 
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('store') ? 'active' : '') }}" href="{{ route('store.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa-solid fa-shop text-dark"></i>
          </div>
          <span class="nav-link-text ms-1">Input Toko</span>
        </a>
      </li>
      @endif
      @if (auth()->user()->role->role_name === 'Business Development Staff' || auth()->user()->role->role_name === 'Manager Business Development')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('BD') ? 'active' : '') }}" href="{{ route('BD.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa-solid fa-arrow-up-right-dots text-dark"></i>
          </div>
          <span class="nav-link-text ms-1">Input Business Development</span>
        </a>
      </li>
      @endif
      {{-- <li class="nav-item">
        <a class="nav-link {{ (Request::is('billing') ? 'active' : '') }}" href="{{ url('input_bd') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
