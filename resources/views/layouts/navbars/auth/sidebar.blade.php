...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header text-center align-items-center">
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="align-items-center d-flex m-0 navbar-brand" href="{{ route('dashboard') }}">
  ...
  <div class="w-auto" id="sidenav-collapse-main"><!--collapse navbar-collapse !-->
    <ul class="navbar-nav">
      ...
      <!-- FINANCE -->
      @if (auth()->check() && auth()->user()->hasRole('Finance', 'Manager Business Development'))
        <li class="nav-item">
      ...
      <!-- OPERATIONAL -->
      @if (auth()->check() && auth()->user()->hasRole('Operational', 'Manager Business Development'))
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('operational') ? 'active' : '') }}" href="{{ route('operational.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-gears text-dark"></i>
            </div>
            <span class="nav-link-text ms-1">Operational</span>
          </a>
        </li>
      @endif

      <!-- STORE -->
      @if (auth()->check() && auth()->user()->hasRole('Area Manager', 'Store Manager', 'Manager Business Development'))
        <li class="nav-item">
      ...
      @if (auth()->check() && auth()->user()->hasRole('Business Development Staff', 'Manager Business Development'))
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('bd') ? 'active' : '') }}" href="{{ route('bd.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-arrow-up-right-dots text-dark"></i>
            </div>
            <span class="nav-link-text ms-1">Business Development</span>
          </a>
        </li>
      @endif
